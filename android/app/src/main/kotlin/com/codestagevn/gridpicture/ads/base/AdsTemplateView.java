package com.codestagevn.gridpicture.ads.base;
...
public class AdsTemplateView extends FrameLayout {

    private int templateType;
    private NativeAdsStyle styles;
    ...
    public AdsTemplateView(Context context) {
        super(context);
    }

    public void setStyles(NativeAdsStyle styles) {
        this.styles = styles;
        this.applyStyles();
    }
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.ads_medium_template_view) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.ads_small_template_view) {
